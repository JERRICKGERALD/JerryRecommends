...
st.markdown("<h1 style='text-align: top-left; color: ; font-family: Garamond, sans-serif; '> Jerry Recommends </h1>", unsafe_allow_html=True)
st.markdown("<h3 style='text-align: left; color:#f95959;'> Before I suggest ! Let me know your taste! </h3>", unsafe_allow_html=True)
